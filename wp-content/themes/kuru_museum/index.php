...
if($_GET['album']){
	$album = $_GET['album']?'/media-centre/?album='.$_GET['album']:'';
	$gallery = $_GET['gallery']?'&gallery='.$_GET['gallery']:'';
 $site_url = get_site_url().$album.$gallery;

//locate_template('Gallery', $load = false, $require_once = true );	
//get_template_part( '', 'Gallery' ); 
     echo "<script type='text/javascript'>";
    // echo "alert('Congratulation! You have Successfully Login.');";
